...
public class RestClient {
    ...
    /**
     * Added by Ivan Root 06.08.2018
     * Simply get Download link by path from CloudApi
     *
     */

    public Link getDownloadLink(final String path) throws IOException, ServerIOException{
